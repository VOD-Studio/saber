...
func TestCoreDependencies(t *testing.T) {
	command := exec.Command("go", "list", "-tags", "goolm", "-deps", "rua.plus/saber/internal/agent", "rua.plus/saber/internal/chat/...", "rua.plus/saber/internal/conversation", "rua.plus/saber/internal/model", "rua.plus/saber/internal/mcp")
